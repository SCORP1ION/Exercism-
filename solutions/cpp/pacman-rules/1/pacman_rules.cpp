...
bool can_eat_ghost(bool power_pellet_active, bool touching_ghost) {
    return ((power_pellet_active == true) && (touching_ghost == true));
}
...
bool scored(bool touching_power_pellet, bool touching_dot) {
    ...
    return ((touching_power_pellet == true) || (touching_dot == true));
}
...
bool won(bool has_eaten_all_dots, bool power_pellet_active,
   ...
   return ((has_eaten_all_dots == true) && (!((power_pellet_active != true) && (touching_ghost == true))));
}
